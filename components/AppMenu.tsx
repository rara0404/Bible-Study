...
export function AppMenu({ onNavigate, active }: AppMenuProps) {
  ...
  const ITEM_ICON_SIZE = 32; // make menu icons bigger
  ...
  <MenuIcon size={TRIGGER_ICON_SIZE} className="text-gray-700 dark:text-gray-200" strokeWidth={2} />
      ...
      >
        ...
        <DropdownMenuItem
          onClick={() => go("home")}
          className={
            `group w-full h-14 pl-3 pr-3 rounded-md cursor-pointer transition text-[15px] flex items-center gap-0 focus:bg-gray-100 dark:focus:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-800`
          }
        >
